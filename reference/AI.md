...
| **High cost** | Most expensive | ONLY for very large tasks and/or many things at once — large migrations, big multi-file/architectural changes, deep root-cause debugging, security reviews. Use sparingly. | Claude Opus / GPT-5 (deep reasoning) / Gemini Pro (advanced reasoning) |
