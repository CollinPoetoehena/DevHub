...
**Practical rule of thumb:** start simple, escalate (i.e. **to higher tiers**) only when necessary, and use the no‑cost tier (with optional higher‑tier reasoning models) as your safety net for general things:
