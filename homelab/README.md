...
The documentation has two main components:
1. **[Design](./docs/1_Design/README.md)**: Overview of the home lab design, including personal goals, network topology, node setup, and overall architecture.
2. **[Setup](./docs/2_Setup/README.md)**: Step-by-step guide for setting up the home lab, using the design as a reference.
