...
// Access a specific value with e.g.: module.vm.nic_ids["app-server-mgmt-nic"]
...
output "nic_names" {
  description = "Map of NIC key (<vm-name>-<nic-name>) to NIC name as created in Azure (same as key, included for consistency with other outputs)"
